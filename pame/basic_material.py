...
#	nplot=DelegatesTo('mview')
	...
	def _earray_changed(self): self.update_mview()
	...
	def _allview_default(self): return MultiView(nameplot=self.allplots, host=self.mat_name)
	...
	def _allbutt_fired(self): self.allview.edit_traits()
